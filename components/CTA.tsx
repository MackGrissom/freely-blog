...
export default function CTA() {
  return (
    <div className="mt-20 bg-white py-24 dark:bg-transparent sm:py-32 dark:text-white">
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            {benefits.map((benefit) => (
              <div key={benefit.name} className="relative pl-16">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600 dark:text-gray-400">{benefit.description}</dd>
              </div>
            ))}
          </dl>
        </div>
